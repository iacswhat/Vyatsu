...
q:=7*pi/180;
for i:=0 to 7 do begin
v[i].x:=v[i].x*(n1*n1+(1-n1*n1)*cos(q))+v[i].y*(n1*n2*(1-cos(q))-n3*sin(q))+v[i].z*(n1*n3*(1-cos(q))+n2*sin(q));
v[i].y:=v[i].x*(n1*n2*(1-cos(q))+n3*sin(q))+v[i].y*(n2*n2+(1-n2*n2)*cos(q))+v[i].z*(n2*n3*(1-cos(q))-n1*sin(q));
v[i].z:=v[i].x*(n1*n3*(1-cos(q))-n2*sin(q))+v[i].y*(n2*n3*(1-cos(q))+n1*sin(q))+v[i].z*(n3*n3+(1-n3*n3)*cos(q));
end;
end;
