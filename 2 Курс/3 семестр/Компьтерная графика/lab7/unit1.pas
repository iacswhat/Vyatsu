...
procedure TForm1.povorot2(q: real);
begin
q:=7*pi/180;
for i:=0 to 7 do begin
v[i].x:=help[i].x*(n1*n1+(1-n1*n1)*cos(q))+help[i].y*(n1*n2*(1-cos(q))-n3*sin(q))+help[i].z*(n1*n3*(1-cos(q))+n2*sin(q));
v[i].y:=help[i].x*(n1*n2*(1-cos(q))+n3*sin(q))+help[i].y*(n2*n2+(1-n2*n2)*cos(q))+help[i].z*(n2*n3*(1-cos(q))-n1*sin(q));
v[i].z:=help[i].x*(n1*n3*(1-cos(q))-n2*sin(q))+help[i].y*(n2*n3*(1-cos(q))+n1*sin(q))+help[i].z*(n3*n3+(1-n3*n3)*cos(q));
end;
end;
