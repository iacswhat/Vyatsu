...
namespace Dbproject
{
    public partial class Form1 : Form
    {
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            string sql = "SELECT id,Установка,Тип_комплектующего,Обозначение,Наименование,Серийный_номер,Поставщик,Изготовитель,Дата_изготовления,Срок_хранения,Страна_изготовления FROM ust1 WHERE Установка =" + "'" + ust + "'" + " and Тип_комплектующего=" + "'" + comp + "'";
            UpdateGrid(sql);
