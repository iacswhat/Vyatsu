//* System 5x7 (version 2) (char #32 to #128) */
const unsigned short FontSystem5x7_v2[] = {
        ...
        0x06,0x09,0x09,0x06,0x00  // oC 0x81
        };

const unsigned short font5x7[] = {
...
const unsigned short System3x5[] = {
...
const unsigned short Character8x7[] = {
        ...
        152, 252, 100,  60,  62,  39,  61,  24, //'_'
         28,  62, 107,  73,  73,   0,   0,   0, //'_'
        126, 127,   1,   1, 127, 126,   0,   0, //'_'
         42,  42,  42,  42,  42,  42,   0,   0, //'_'
         68,  68,  95,  95,  68,  68,   0,   0, //'_'
         64,  81,  91,  78,  68,  64,   0,   0, //'_'
         64,  68,  78,  91,  81,  64,   0,   0, //'_'
          0,   0,   0, 254, 255,   1,   7,   6, //'_'
         96, 224, 128, 255, 127,   0,   0,   0, //'_'
          8,   8, 107, 107,   8,   8,   0,   0, //'_'
         36,  54,  18,  54,  36,  54,  18,   0, //'_'
          0,   6,  15,   9,  15,   6,   0,   0, //'_'
          0,   0,   0,  24,  24,   0,   0,   0, //'ò'
          0,   0,   0,  16,  16,   0,   0,   0, //'+'
         16,  48, 112, 192, 255, 255,   1,   1, //'_'
          0,  31,  31,   1,  31,  30,   0,   0, //'n'
          0,  25,  29,  23,  18,   0,   0,   0, //'_'
          0,   0,  60,  60,  60,  60,   0,   0, //'_'
          0,   0,  14,  31,  17,  17,  31,   14 //'°'
        };
