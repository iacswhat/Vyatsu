 ...
 * Test configuration:
     ...
     Ext. Modules:    ac:Serial_Ethernet  mE Serial Ethernet board on PORT0
...
sfr sbit SPI_Ethernet_RST at P0_4_bit;
sfr sbit SPI_Ethernet_CS  at P0_5_bit;
...
void    main()
        ...
        P0MDOUT |= 0b00110101;                    // Configure P0.5(CS), P0.4(RST),
                                                  //   P0.2(MOSI) and P0.0(SCK) pin as push-pull
