...
parameterValues["КПП"] := ["АКПП", "МКПП"] 
parameterValues["Бензин"] := ["100", "92", "95"] 
parameterValues["Объем_бака"] := ["40", "55", "65"]
parameterValues["Вместительность"] := ["2", "4", "5"]
parameterValues["Скорость"] := ["150", "200", "250"]
parameterValues["Страна"] := ["Германия", "Россия", "США", "Япония"]
parameterValues["Масса"] := ["1000", "1500", "2000"]
parameterValues["Стоимость"] := ["Большая", "Низкая", "Средняя"]





APP_PATH := "C:\Users\Кирилл\Desktop\anies_\"
